...
public class ReviewController {
	...
	public ResponseEntity<?> likeReview(@PathVariable Integer recipeId, @PathVariable Integer userId)
	{
		try {
	...
	public ResponseEntity<?> dislikeReview(@PathVariable Integer recipeId, @PathVariable Integer userId)
	{
		try {
	...
	public ResponseEntity<?> unlikeReview(@PathVariable Integer recipeId, @PathVariable Integer userId)
	{
		try {
	...
	public ResponseEntity<?> undislikeReview(@PathVariable Integer recipeId, @PathVariable Integer userId)
	{
		try {
	...
	public ResponseEntity<?> getRecipeReviews(@PathVariable Integer recipeId)
	{
		try {
	...
	public ResponseEntity<?> deleteReview(@PathVariable Integer recipeId)
	{
		try {
	...
	public ResponseEntity<?> createReview(@PathVariable Integer recipeId, @RequestBody String reviewText)
	{
		try {
